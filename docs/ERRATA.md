...
- **Part 2 — Findings register (F04–F33).** Defects found against v0.2, plus those found during implementation. Resolved entries are struck through and say what resolved them; the rest carry a proposed resolution. Severity: **P0** = produces a wrong or unbuildable engine; **P1** = will need rework; **P2** = tidy-up.
